            ...
            <div className='home-about'>
                ...
                <div className='container-resumo-fotos'>
                    ...
                    <div className='div-resumo'>
                        ...
                        Em nosso espaço o cliente encontra tudo o que precisa para seu animal, como brinquedos, acessórios e alimentação.
                        </p>O projeto foi desenvolvido por 5 estudantes de diferentes nacionalidades, tais como: Angola, Haiti e Venezuela.
